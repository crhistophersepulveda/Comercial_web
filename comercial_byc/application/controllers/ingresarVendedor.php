...
class ingresarVendedor extends CI_Controller{
	...
	public function ingresarvendedor(){
        ...
        function rut_chequeo($rut){
                if(!strpos($rut, "-")){
                        $this->form_validation->set_message('rut_chequeo', '  <div class="alert alert-danger" style="display: block;" >
                                                                ERROR!! El rut debe ingresarse de la siguiente manera 11222333-4
                                                                </div>');
                        return FALSE;
                }
