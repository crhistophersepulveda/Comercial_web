                            ...
                            <form role="form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <button type='button' class='btn btn-warning btn-circle' data-toggle='modal' data-target='#h' > <i class='fa fa-times'></i></button>
                                                
                                                   <div class='modal fade bs-example-modal-lg' id='h' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true' style='display: none;'>
