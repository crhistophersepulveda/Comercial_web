...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ingreso Artículo</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                    ...
                                    <form action='prueba.php'  method='post' role="form">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label>Codigo</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <?php 
                                                    foreach ($proveedor-> result() as $proveedors){
                                                        echo "  
                                                        <option></option>
                                                        <option>$proveedors->razon_social</option>";
                                                    }
                                                ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input class="form-control" name="Fecha_compra"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <label>Precio ferretera</label>
                                                <input class="form-control" name="Precio_ferretera"/>
                                            </div>

                                            <div class="col-md-2">
                                                <label>Precio especialista</label>
                                                <input class="form-control" name="Precio_especialista" />
                                            </div>

                                            <div class="col-md-2">
                                                <label>Precio constructora</label>
                                                <input class="form-control" name="Precio_constructora" />
                                            </div>
                                        </div>
